...
public class FMProtectionCore extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        server.getPluginManager().registerEvents(pListener, this);
    ...
    public void loadZones() {
        ...
        try {
            while (result != null && result.next()) {
                ...
                // System.out.println("loaded: " + zone.toString());
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        // CoK-Map
//        if (!player.getWorld().getName().equalsIgnoreCase("world") && !player.getWorld().getName().equalsIgnoreCase("world_the_end")) {
//            player.sendMessage(ChatColor.RED + "[FlyZone] FlyZones are not allowed in this world!");
//            return true;
//        }
